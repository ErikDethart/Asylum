...
life_phone_buttons = [
	["Admin", "icons\phone_admin.paa", "createDialog ""life_admin_menu""", "life_adminlevel > 1", "Access restricted administration menu"],
	["Camera", "icons\phone_camera.paa", "[] call BIS_fnc_camera; closeDialog 0;", "life_adminlevel > 1", "Open the admin camera"],
	...
	//["Donation", "icons\phone_donate.paa", "createDialog ""life_donation_menu""", "life_adminlevel < 2", "View your donor level and donation rewards"],
...
life_achievementInfo = [
	...
	[[civilian,west,independent], "Upper Class", {life_wealthPrestige  >= 500000}, "Obtained over 500,000 prestige and Money cap: $1,500,000", "None"],
	[[civilian,west,independent], "Prominent", {life_wealthPrestige >= 1000000}, "Obtained over 1,000,000 prestige.", "Title: Prominent, Money Cap: $2,000,000, Jury Corruption", "The Prominent %1"],
	[[civilian,west,independent], "Tycoon", {life_wealthPrestige >= 5000000}, "Obtained over 5,000,000 prestige.", "Title: Tycoon, Money Cap: $6,000,000, Global Discounts", "Tycoon %1"],
	[[civilian,west,independent], "Eminent", {life_wealthPrestige >= 10000000}, "Obtained over 10,000,000 prestige.", "Title: Eminent, Money Cap: Unlimited, Purchasable Jet", "The Eminent %1"],
	...
	[[civilian,west,independent], "Gang Wars Champion", {false}, "Reigning Champion of the Asylum Gang Wars", "Title: Gang Wars V Winner", "Gang Wars V Winner %1", true]
];
...
life_revive_fee = 1500; // Fee to pay for revive
life_last_shank = -200;
...
life_vehicleInfo = switch (worldName) do {
	case "Altis": {
		[
			...
			["reb_car","O_LSV_02_armed_F",150000,0,0,0,0,106,civilian,0,0,false],
			...
			["bh_car","B_T_LSV_01_unarmed_F",6000,140,0,0,0,0,civilian,0,0,false],
			...
			["cop_car","B_T_LSV_01_unarmed_F",20000,140,0,3,0,100,west,0,0,false],
			...
			["cop_car","B_T_LSV_01_unarmed_F",20000,140,0,3,0,100,west,41,0,false],
			...
			["cop_air","I_Heli_light_03_unarmed_F",60000,100,0,3,0,98,west,0,0,false],
