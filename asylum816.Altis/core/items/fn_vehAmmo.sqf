...
if !(typeOf (vehicle player) in ["B_G_Offroad_01_armed_F","O_LSV_02_armed_F","I_C_Offroad_02_LMG_F"]) exitWith {hint "The ammunition does not fit this vehicles weapons."};
