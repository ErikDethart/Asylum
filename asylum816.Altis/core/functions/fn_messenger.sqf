...
switch (playerSide) do
{
	...
	case civilian: { [] spawn { while {true} do { sleep 1400; hint parseText "<t color='#FFCC00'><t size='2'><t align='center'>Server Message<br/><br/><t color='#33CC33'><t align='left' size='1'><t color='#33CC33'>Message:<br/><t color='#ffffff'>While there's a lot of action to be had, Asylum is a role-playing community. Have fun and remember to talk before shooting. RDM is a bannable offense!"; sleep 1000; }; }; };
};
